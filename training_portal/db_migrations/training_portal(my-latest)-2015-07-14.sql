...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2015 at 05:34 PM
...
CREATE TABLE IF NOT EXISTS `aaa_aaa` (
...
--
-- Dumping data for table `aaa_aaa`
--

INSERT INTO `aaa_aaa` (`id`, `name`) VALUES
(1, 'aaa4'),
(2, 'aaa2'),
(3, 'aaa3');
...
--
-- Table structure for table `aaa_bbb_ccc`
--

CREATE TABLE IF NOT EXISTS `aaa_bbb_ccc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aaa_aaa_id` int(11) DEFAULT NULL,
  `bbb_bbb_id` int(11) DEFAULT NULL,
  `ccc_ccc_id` int(11) DEFAULT NULL,
  `value` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_FA95566C220BA5E2` (`aaa_aaa_id`),
  KEY `IDX_FA95566CADBF8257` (`bbb_bbb_id`),
  KEY `IDX_FA95566CD72C60C4` (`ccc_ccc_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;

--
-- Dumping data for table `aaa_bbb_ccc`
--

INSERT INTO `aaa_bbb_ccc` (`id`, `aaa_aaa_id`, `bbb_bbb_id`, `ccc_ccc_id`, `value`) VALUES
(1, 1, 1, 1, 'value of aaabbbccc1'),
(2, 2, 2, 2, 'value of aaabbbccc2'),
(3, 1, 3, 2, 'value of aaabbbccc3');

-- --------------------------------------------------------

--
-- Table structure for table `bbb_bbb`
--

CREATE TABLE IF NOT EXISTS `bbb_bbb` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;
...
--
-- Dumping data for table `bbb_bbb`
--

INSERT INTO `bbb_bbb` (`id`, `name`) VALUES
(1, 'bbb1'),
(2, 'bbb2'),
(3, 'bbb3');
...
(1, 'ميزانية1', NULL, NULL, 1, 1),
(2, 'ميزانية2', '2014-12-01', '2014-12-30', 1, 1),
(3, 'ميزانية3', '2014-12-16', '2014-12-25', 1, 1),
(4, 'ميزانية4', NULL, NULL, 1, 1),
(5, 'ميزانية5', NULL, NULL, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `ccc_ccc`
--

CREATE TABLE IF NOT EXISTS `ccc_ccc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `ccc_ccc`
--

INSERT INTO `ccc_ccc` (`id`, `name`) VALUES
(1, 'ccc1'),
(2, 'ccc2');
...
CREATE TABLE IF NOT EXISTS `trainings` (
  ...
  `modified_date` datetime DEFAULT NULL,
  `modified_by` int(10) unsigned DEFAULT NULL,
  `self_request_trainingneed_id` int(10) unsigned DEFAULT NULL,
  `related_tasks` text COLLATE utf8_unicode_ci NOT NULL,
  ...
  KEY `country` (`country`),
  KEY `self_request_trainingneed_id` (`self_request_trainingneed_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `training_needs` (
  ...
  `modified_date` datetime DEFAULT NULL,
  `modified_by` int(10) unsigned DEFAULT NULL,
  `trainingneed_period_id` tinyint(3) unsigned DEFAULT NULL,
  PRIMARY KEY (`id_need`),
...
INSERT INTO `users` (`id_user`, `username`, `password`, `employee_grade`, `active`, `able_to_request_training`, `created_date`, `created_by`, `modified_date`, `modified_by`, `arabic_fullname`, `english_fullname`, `email`) VALUES
(1, 'aaalshehri', '7c4a8d09ca3762af61e59520943dc26494f8941b', '1', 1, 1, NULL, NULL, NULL, NULL, NULL, '', ''),
(2, 'asabra', '7c4a8d09ca3762af61e59520943dc26494f8941b', '1', 1, 1, NULL, NULL, NULL, NULL, NULL, '', '');
...
--
-- Constraints for table `aaa_bbb_ccc`
--
ALTER TABLE `aaa_bbb_ccc`
  ADD CONSTRAINT `FK_FA95566C220BA5E2` FOREIGN KEY (`aaa_aaa_id`) REFERENCES `aaa_aaa` (`id`),
  ADD CONSTRAINT `FK_FA95566CADBF8257` FOREIGN KEY (`bbb_bbb_id`) REFERENCES `bbb_bbb` (`id`),
  ADD CONSTRAINT `FK_FA95566CD72C60C4` FOREIGN KEY (`ccc_ccc_id`) REFERENCES `ccc_ccc` (`id`);
...
ALTER TABLE `trainings`
  ...
  ADD CONSTRAINT `trainings_ibfk_1` FOREIGN KEY (`country`) REFERENCES `countries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `trainings_ibfk_2` FOREIGN KEY (`self_request_trainingneed_id`) REFERENCES `training_needs` (`id_need`) ON DELETE NO ACTION ON UPDATE NO ACTION,
