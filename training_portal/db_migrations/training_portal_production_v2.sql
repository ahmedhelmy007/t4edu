...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2015 at 06:12 AM
...
CREATE TABLE IF NOT EXISTS `trainings` (
  ...
  `related_tasks` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'admin', NULL, 1, NULL, '2014-11-12 09:41:00', NULL, '2014-11-16 11:08:48', NULL, '161ebd7d45089b3446ee4e0d86dbcf92', 'Super Admin', 'Super Admin');
...
ALTER TABLE `trainings`
  ...
  ADD CONSTRAINT `trainings_ibfk_4` FOREIGN KEY (`self_request_trainingneed_id`) REFERENCES `training_needs` (`id_need`) ON DELETE NO ACTION ON UPDATE NO ACTION,
